		...
		<div class="agile-grids">
			...
			<div class="col-md-6 agile-grid-left">
				<div class="main">
					...
					<h3 id="column">Male/Female Rental Number</h3>
					<table id='myTable1'>
						...
						<tr>
							...
							float[][] gendernum = us.gendernumPerMonthIn2016();
			...
			<div class="col-md-6 agile-grid-right">
				<div class="main">
					...
					<h3 id="pie">Ratio: Male/Total of each month in 2016</h3>
					<table id='myTable4'>
