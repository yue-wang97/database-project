...
<!DOCTYPE html>
<head>
	<title>Average Distance of Month</title>
	...
	<div class="main-grid">
		<div class="agile-grids">
			...
			<div class="chart-heading">
				<h2>Average Distance of Month</h2>
			</div>
			...
			<div class="col-md-6 agile-grid-left">
				<div class="main">
					<table id='myTable2'>
						<caption>Different Month</caption>
						<thead>
						<tr>
							<th></th>
							<th>Jan</th>
						...
						<%
							...
							float[] dis = us.avgDistancePerMonthin2016();
						%>
						<tbody>
						<tr>
							<th>distance</th>
			...
			<div class="col-md-6 agile-grid-right">
				...
				<p>During March to May in 2016, people tended to ride for longer distance. <br/>
				After September, the riding distance gets low.<br/>
				Probably due to the temperature and UV level.</p>
			</div>
