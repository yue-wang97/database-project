    ...
    <div class="main-grid">
        <div class="agile-grids">
            ...
            <div class="chart-heading">
                <h2>Chosen Number in Each Month</h2>
            </div>

            <!-- agile-grid-left -->
            <div class="chart-heading">
                <div class="main">
                    <h3 id="area">Number</h3>
                    <table id='myTable2'>
                        <caption>Chosen Number in Each Month</caption>
                        <thead>
                        <tr>
                            <th></th>
                            <th>Jan</th>
                        ...
                        <%
							...
							int[] endnumber = us.endStationPerMonthIn2016(station);
						%>
                        <tbody>
                        <tr>
                            <th><%=station %></th>
                            <%
							for(int i=0;i<endnumber.length;i++){  
							%>
								<td><%=endnumber[i] %></td>
							<%} %>
                        </tr>
