			...
			<div class="agile-tables">
				<div class="w3l-table-info">
					...
					<table id="table">
						...
						String[][] moststart = us.moststartIn2016();
						%>
						<tr>
							<th>Station Name</th>
							<th>Times</th>
						...
						<tbody>
						<%
						for(int i=0;i<moststart.length;i++){  
						%>
						<tr>
							<td><a href="test2.jsp?station=<%=moststart[i][0]%>"><%=moststart[i][0] %></a></p></td>
							<td><%=moststart[i][1] %></td>
						</tr>
						<%} %>
